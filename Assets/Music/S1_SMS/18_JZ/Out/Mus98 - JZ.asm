Mus98_JZ_S1SMS_Header:
	...
	smpsHeaderPSG       Mus98_JZ_S1SMS_PSG4,	$00, $00, $00, $00
...
Mus98_JZ_S1SMS_PSG3_Loop00:
	...
	dc.b	$02, nRst, $0C
	smpsPSGAlterVol     $FD
	smpsLoop            $00, $02, Mus98_JZ_S1SMS_PSG3_Loop00

Mus98_JZ_S1SMS_PSG3_Loop01:
	dc.b	nD2, $02
	smpsPSGAlterVol     $01
	dc.b	$01
	smpsPSGAlterVol     $01
	...
	dc.b	$02, nRst, $0C
	smpsPSGAlterVol     $FD
	smpsLoop            $00, $02, Mus98_JZ_S1SMS_PSG3_Loop01
	dc.b	nA1, $02
	smpsPSGAlterVol     $01
	dc.b	$01
	smpsPSGAlterVol     $01
...
Mus98_JZ_S1SMS_PSG3_Loop02:
	...
	smpsPSGAlterVol     $01
	smpsAlterNote       $02
	smpsLoop            $00, $02, Mus98_JZ_S1SMS_PSG3_Loop02
	dc.b	$02, nRst, $0C
	smpsPSGAlterVol     $FD
	dc.b	nB1, $02
	smpsPSGAlterVol     $01
...
Mus98_JZ_S1SMS_PSG3_Loop03:
	...
	smpsPSGAlterVol     $01
	smpsAlterNote       $01
	smpsLoop            $00, $02, Mus98_JZ_S1SMS_PSG3_Loop03
	dc.b	$02
	smpsPSGAlterVol     $FD
	dc.b	nE1
	smpsPSGAlterVol     $01
...
Mus98_JZ_S1SMS_PSG3_Loop04:
	...
	smpsAlterNote       $02
	dc.b	$02
	smpsLoop            $00, $02, Mus98_JZ_S1SMS_PSG3_Loop04

Mus98_JZ_S1SMS_PSG3_Loop05:
	dc.b	nRst, $0C
	smpsPSGAlterVol     $FD
	smpsAlterNote       $02
	dc.b	nB1, $02
	...
	smpsAlterNote       $02
	dc.b	$02
	smpsLoop            $00, $04, Mus98_JZ_S1SMS_PSG3_Loop05
	dc.b	nRst, $06
	smpsPSGAlterVol     $FD
	smpsAlterNote       $01
	dc.b	nCs2, $02
...
Mus98_JZ_S1SMS_PSG3_Loop06:
	...
	dc.b	$02, nRst, $0C
	smpsPSGAlterVol     $FD
	smpsLoop            $00, $02, Mus98_JZ_S1SMS_PSG3_Loop06

Mus98_JZ_S1SMS_PSG3_Loop07:
	dc.b	nD2, $02
	smpsPSGAlterVol     $01
	dc.b	$01
	smpsPSGAlterVol     $01
	...
	dc.b	$02, nRst, $0C
	smpsPSGAlterVol     $FD
	smpsLoop            $00, $02, Mus98_JZ_S1SMS_PSG3_Loop07
	dc.b	nA1, $02
	smpsPSGAlterVol     $01
	dc.b	$01
	smpsPSGAlterVol     $01
...
Mus98_JZ_S1SMS_PSG3_Loop08:
	...
	smpsPSGAlterVol     $01
	smpsAlterNote       $02
	smpsLoop            $00, $02, Mus98_JZ_S1SMS_PSG3_Loop08
	dc.b	$02, nRst, $0C
	smpsPSGAlterVol     $FD
	dc.b	nB1, $02
	smpsPSGAlterVol     $01
...
Mus98_JZ_S1SMS_PSG3_Loop09:
	...
	smpsPSGAlterVol     $01
	smpsAlterNote       $01
	smpsLoop            $00, $02, Mus98_JZ_S1SMS_PSG3_Loop09
	dc.b	$02
	smpsPSGAlterVol     $FD
	dc.b	nE1
	smpsPSGAlterVol     $01
...
Mus98_JZ_S1SMS_PSG3_Loop0A:
	...
	smpsAlterNote       $02
	dc.b	$02
	smpsLoop            $00, $02, Mus98_JZ_S1SMS_PSG3_Loop0A

Mus98_JZ_S1SMS_PSG3_Loop0B:
	dc.b	nRst, $0C
	smpsPSGAlterVol     $FD
	smpsAlterNote       $02
	dc.b	nB1, $02
	...
	smpsAlterNote       $02
	dc.b	$02
	smpsLoop            $00, $02, Mus98_JZ_S1SMS_PSG3_Loop0B
	dc.b	nRst, $0C
	smpsPSGAlterVol     $FD
	smpsAlterNote       $01
	dc.b	nE1, $02
...
Mus98_JZ_S1SMS_PSG3_Loop0C:
	...
	smpsAlterNote       $00
	dc.b	nG2, $02
	smpsLoop            $00, $02, Mus98_JZ_S1SMS_PSG3_Loop0C
	smpsPSGAlterVol     $01
	smpsAlterNote       $00
	dc.b	$01
	smpsPSGAlterVol     $01
...
Mus98_JZ_S1SMS_PSG3_Loop0D:
	...
	smpsPSGAlterVol     $01
	smpsAlterNote       $00
	smpsLoop            $00, $02, Mus98_JZ_S1SMS_PSG3_Loop0D
	dc.b	$02
	smpsPSGAlterVol     $FD
	smpsAlterNote       $01
	dc.b	nB2
...
Mus98_JZ_S1SMS_PSG3_Loop0E:
	...
	dc.b	$02, nRst, $0C
	smpsPSGAlterVol     $FD
	smpsLoop            $00, $02, Mus98_JZ_S1SMS_PSG3_Loop0E
	smpsAlterNote       $01
	dc.b	nD2, $02
	smpsPSGAlterVol     $01
	smpsAlterNote       $01
...
Mus98_JZ_S1SMS_PSG3_Loop0F:
	...
	smpsPSGAlterVol     $01
	smpsAlterNote       $01
	smpsLoop            $00, $02, Mus98_JZ_S1SMS_PSG3_Loop0F
	dc.b	$02
	smpsPSGAlterVol     $FD
	smpsAlterNote       $01
	dc.b	nD2
...
Mus98_JZ_S1SMS_PSG4_Loop00:
	...
	smpsPSGAlterVol     $07
	dc.b	nRst, $0A
	smpsLoop            $00, $1F, Mus98_JZ_S1SMS_PSG4_Loop00
	smpsPSGAlterVol     $F9
	dc.b	nRst, $02
	smpsPSGAlterVol     $07
	dc.b	nRst, $04
...
Mus98_JZ_S1SMS_PSG4_Loop01:
	...
	dc.b	nRst, $04
	smpsPSGAlterVol     $F9
	smpsLoop            $00, $0C, Mus98_JZ_S1SMS_PSG4_Loop01

Mus98_JZ_S1SMS_PSG4_Loop02:
	dc.b	nRst, $02
	smpsPSGAlterVol     $07
	dc.b	nRst, $10
	smpsPSGAlterVol     $F9
	smpsLoop            $00, $03, Mus98_JZ_S1SMS_PSG4_Loop02
	dc.b	nRst, $02
	smpsPSGAlterVol     $07
	dc.b	nRst, $10
	smpsPSGAlterVol     $F7
