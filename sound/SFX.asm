...
; SFX data
; ---------------------------------------------------------------------------
SoundA0:	include	"sound/sfx/S1/SndA0 - Jump.asm"
		even
SoundA1:	include	"sound/sfx/S1/SndA1 - Lamppost.asm"
		even
SoundA2:	include	"sound/sfx/S1/SndA2.asm"
		even
SoundA3:	include	"sound/sfx/S1/SndA3 - Death.asm"
		even
SoundA4:	include	"sound/sfx/S1/SndA4 - Skid.asm"
		even
SoundA5:	include	"sound/sfx/S1/SndA5.asm"
		even
SoundA6:	include	"sound/sfx/S1/SndA6 - Hit Spikes.asm"
		even
SoundA7:	include	"sound/sfx/S1/SndA7 - Push Block.asm"
		even
SoundA8:	include	"sound/sfx/S1/SndA8 - SS Goal.asm"
		even
SoundA9:	include	"sound/sfx/S1/SndA9 - SS Item.asm"
		even
SoundAA:	include	"sound/sfx/S1/SndAA - Splash.asm"
		even
SoundAB:	include	"sound/sfx/S1/SndAB.asm"
		even
SoundAC:	include	"sound/sfx/S1/SndAC - Hit Boss.asm"
		even
SoundAD:	include	"sound/sfx/S1/SndAD - Get Bubble.asm"
		even
SoundAE:	include	"sound/sfx/S1/SndAE - Fireball.asm"
		even
SoundAF:	include	"sound/sfx/S1/SndAF - Shield.asm"
		even
SoundB0:	include	"sound/sfx/S1/SndB0 - Saw.asm"
		even
SoundB1:	include	"sound/sfx/S1/SndB1 - Electric.asm"
		even
SoundB2:	include	"sound/sfx/S1/SndB2 - Drown Death.asm"
		even
SoundB3:	include	"sound/sfx/S1/SndB3 - Flamethrower.asm"
		even
SoundB4:	include	"sound/sfx/S1/SndB4 - Bumper.asm"
		even
SoundB5:	include	"sound/sfx/S1/SndB5 - Ring.asm"
		even
SoundB6:	include	"sound/sfx/S1/SndB6 - Spikes Move.asm"
		even
SoundB7:	include	"sound/sfx/S1/SndB7 - Rumbling.asm"
		even
SoundB8:	include	"sound/sfx/S1/SndB8.asm"
		even
SoundB9:	include	"sound/sfx/S1/SndB9 - Collapse.asm"
		even
SoundBA:	include	"sound/sfx/S1/SndBA - SS Glass.asm"
		even
SoundBB:	include	"sound/sfx/S1/SndBB - Door.asm"
		even
SoundBC:	include	"sound/sfx/S1/SndBC - Teleport.asm"
		even
SoundBD:	include	"sound/sfx/S1/SndBD - ChainStomp.asm"
		even
SoundBE:	include	"sound/sfx/S1/SndBE - Roll.asm"
		even
SoundBF:	include	"sound/sfx/S1/SndBF - Get Continue.asm"
		even
SoundC0:	include	"sound/sfx/S1/SndC0 - Basaran Flap.asm"
		even
SoundC1:	include	"sound/sfx/S1/SndC1 - Break Item.asm"
		even
SoundC2:	include	"sound/sfx/S1/SndC2 - Drown Warning.asm"
		even
SoundC3:	include	"sound/sfx/S1/SndC3 - Giant Ring.asm"
		even
SoundC4:	include	"sound/sfx/S1/SndC4 - Bomb.asm"
		even
SoundC5:	include	"sound/sfx/S1/SndC5 - Cash Register.asm"
		even
SoundC6:	include	"sound/sfx/S1/SndC6 - Ring Loss.asm"
		even
SoundC7:	include	"sound/sfx/S1/SndC7 - Chain Rising.asm"
		even
SoundC8:	include	"sound/sfx/S1/SndC8 - Burning.asm"
		even
SoundC9:	include	"sound/sfx/S1/SndC9 - Hidden Bonus.asm"
		even
SoundCA:	include	"sound/sfx/S1/SndCA - Enter SS.asm"
		even
SoundCB:	include	"sound/sfx/S1/SndCB - Wall Smash.asm"
		even
SoundCC:	include	"sound/sfx/S1/SndCC - Spring.asm"
		even
SoundCD:	include	"sound/sfx/S1/SndCD - Switch.asm"
		even
SoundCE:	include	"sound/sfx/S1/SndCE - Ring Left Speaker.asm"
		even
SoundCF:	include	"sound/sfx/S1/SndCF - Signpost.asm"
		even
