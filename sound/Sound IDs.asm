...
;!@ Sonic 1 FM music
bgm_GHZ =			SMPS_id(ptr_mus08)
bgm_LZ =			SMPS_id(ptr_mus09)
bgm_MZ =			SMPS_id(ptr_mus0A)
bgm_SLZ =			SMPS_id(ptr_mus0B)
bgm_SYZ =			SMPS_id(ptr_mus0C)
bgm_SBZ =			SMPS_id(ptr_mus0D)
bgm_Invincible =	SMPS_id(ptr_mus0E)
bgm_ExtraLife =		SMPS_id(ptr_mus0F)
bgm_SS =			SMPS_id(ptr_mus10)
bgm_Title =			SMPS_id(ptr_mus11)
bgm_Ending =		SMPS_id(ptr_mus12)
bgm_Boss =			SMPS_id(ptr_mus13)
bgm_FZ =			SMPS_id(ptr_mus14)
bgm_GotThrough =	SMPS_id(ptr_mus15)
bgm_GameOver =		SMPS_id(ptr_mus16)
bgm_Continue =		SMPS_id(ptr_mus17)
bgm_Credits =		SMPS_id(ptr_mus18)
bgm_Drowning =		SMPS_id(ptr_mus19)
bgm_Emerald =		SMPS_id(ptr_mus1A)
;New base slots
bgm_LvlSel =		SMPS_id(ptr_mus1B)
bgm_ZoneStart =		SMPS_id(ptr_mus1C)
bgm_Options =		SMPS_id(ptr_mus1D)
bgm_BZ =			SMPS_id(ptr_mus1E)
bgm_JZ =			SMPS_id(ptr_mus1F)
;!@ Sonic 1 SMS Music
bgm_GHZ_S1SMS =			SMPS_id(ptr_mus20)
bgm_LZ_S1SMS =			SMPS_id(ptr_mus21)
bgm_MZ_S1SMS =			SMPS_id(ptr_mus22)
bgm_SLZ_S1SMS =			SMPS_id(ptr_mus23)
bgm_SYZ_S1SMS =			SMPS_id(ptr_mus24)
bgm_SBZ_S1SMS =			SMPS_id(ptr_mus25)
bgm_Invincible_S1SMS =	SMPS_id(ptr_mus26)
bgm_ExtraLife_S1SMS =	SMPS_id(ptr_mus27)
bgm_SS_S1SMS =			SMPS_id(ptr_mus28)
bgm_Title_S1SMS =		SMPS_id(ptr_mus29)
bgm_Ending_S1SMS =		SMPS_id(ptr_mus2A)
bgm_Boss_S1SMS =		SMPS_id(ptr_mus2B)
bgm_FZ_S1SMS =			SMPS_id(ptr_mus2C)
bgm_GotThrough_S1SMS =	SMPS_id(ptr_mus2D)
bgm_GameOver_S1SMS =	SMPS_id(ptr_mus2E)
bgm_Continue_S1SMS =	SMPS_id(ptr_mus2F)
bgm_Credits_S1SMS =		SMPS_id(ptr_mus30)
bgm_Drowning_S1SMS =	SMPS_id(ptr_mus31)
bgm_Emerald_S1SMS =		SMPS_id(ptr_mus32)
;New base slots
bgm_LvlSel_S1SMS =		SMPS_id(ptr_mus33)
bgm_ZoneStart_S1SMS =	SMPS_id(ptr_mus34)
bgm_Options_S1SMS =		SMPS_id(ptr_mus35)
bgm_BZ_S1SMS =			SMPS_id(ptr_mus36)
bgm_JZ_S1SMS =			SMPS_id(ptr_mus37)
