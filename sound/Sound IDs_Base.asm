...
;!@ Sonic 1 FM music
_bgm_GHZ =			SMPS_id(ptr_mus81)
_bgm_LZ =			SMPS_id(ptr_mus82)
_bgm_MZ =			SMPS_id(ptr_mus83)
_bgm_SLZ =			SMPS_id(ptr_mus84)
_bgm_SYZ =			SMPS_id(ptr_mus85)
_bgm_SBZ =			SMPS_id(ptr_mus86)
_bgm_Invincible =	SMPS_id(ptr_mus87)
_bgm_ExtraLife =		SMPS_id(ptr_mus88)
_bgm_SS =			SMPS_id(ptr_mus89)
_bgm_Title =			SMPS_id(ptr_mus8A)
_bgm_Ending =		SMPS_id(ptr_mus8B)
_bgm_Boss =			SMPS_id(ptr_mus8C)
_bgm_FZ =			SMPS_id(ptr_mus8D)
_bgm_GotThrough =	SMPS_id(ptr_mus8E)
_bgm_GameOver =		SMPS_id(ptr_mus8F)
_bgm_Continue =		SMPS_id(ptr_mus90)
_bgm_Credits =		SMPS_id(ptr_mus91)
_bgm_Drowning =		SMPS_id(ptr_mus92)
_bgm_Emerald =		SMPS_id(ptr_mus93)
;New base slots
_bgm_LvlSel =		SMPS_id(ptr_mus94)
_bgm_ZoneStart =		SMPS_id(ptr_mus95)
_bgm_Options =		SMPS_id(ptr_mus96)
_bgm_BZ =			SMPS_id(ptr_mus97)
_bgm_JZ =			SMPS_id(ptr_mus98)
_bgm__Last =		SMPS_id(ptr_musend)-1
...
_sfx__Last =		SMPS_id(ptr_sndend)-1
...
_spec__Last =		SMPS_id(ptr_specend)-1
