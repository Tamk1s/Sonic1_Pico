...
DACMetadata macro pSampleRate,pStart
	...
	dc.w	(pSampleRate*$100)/SMPS_DAC_SAMPLE_RATE	; Playback increment (8.8 format)
...
Snare		IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic 1 & 2/Snare.pcm"
Timpani		IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic 1 & 2/Timpani.pcm"
    endif

    if SMPS_S2DACSamples
Clap		IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic 1 & 2/Clap.pcm"
Scratch		IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic 1 & 2/Scratch.pcm"
Tom		IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic 1 & 2/Tom.pcm"
Bongo		IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic 1 & 2/Bongo.pcm"
    endif

    if SMPS_S3DACSamples||SMPS_SKDACSamples||SMPS_S3DDACSamples
SnareS3		IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic 3 & K & 3D/SnareS3.pcm"
TomS3		IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic 3 & K & 3D/TomS3.pcm"
KickS3		IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic 3 & K & 3D/KickS3.pcm"
MuffledSnare	IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic 3 & K & 3D/MuffledSnare.pcm"
CrashCymbal	IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic 3 & K & 3D/CrashCymbal.pcm"
RideCymbal	IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic 3 & K & 3D/RideCymbal.pcm"
MetalHit	IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic 3 & K & 3D/MetalHit.pcm"
MetalHit2	IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic 3 & K & 3D/MetalHit2.pcm"
MetalHit3	IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic 3 & K & 3D/MetalHit3.pcm"
ClapS3		IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic 3 & K & 3D/ClapS3.pcm"
ElectricTom	IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic 3 & K & 3D/ElectricTom.pcm"
SnareS32	IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic 3 & K & 3D/SnareS32.pcm"
TimpaniS3	IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic 3 & K & 3D/TimpaniS3.pcm"
SnareS33	IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic 3 & K & 3D/SnareS33.pcm"
Click		IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic 3 & K & 3D/Click.pcm"
PowerKick	IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic 3 & K & 3D/PowerKick.pcm"
QuickGlassCrash	IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic 3 & K & 3D/QuickGlassCrash.pcm"
    endif

    if SMPS_S3DACSamples||SMPS_SKDACSamples
GlassCrashSnare	IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic 3 & K & 3D/GlassCrashSnare.pcm"
GlassCrash	IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic 3 & K & 3D/GlassCrash.pcm"
GlassCrashKick	IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic 3 & K & 3D/GlassCrashKick.pcm"
QuietGlassCrash	IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic 3 & K & 3D/QuietGlassCrash.pcm"
SnareKick	IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic 3 & K & 3D/SnareKick.pcm"
KickBass	IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic 3 & K & 3D/KickBass.pcm"
ComeOn		IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic 3 & K & 3D/ComeOn.pcm"
DanceSnare	IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic 3 & K & 3D/DanceSnare.pcm"
LooseKick	IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic 3 & K & 3D/LooseKick.pcm"
LooseKick2	IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic 3 & K & 3D/LooseKick2.pcm"
Woo		IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic 3 & K & 3D/Woo.pcm"
Go		IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic 3 & K & 3D/Go.pcm"
SnareGo		IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic 3 & K & 3D/SnareGo.pcm"
PowerTom	IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic 3 & K & 3D/PowerTom.pcm"
WoodBlock	IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic 3 & K & 3D/WoodBlock.pcm"
HitDrum		IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic 3 & K & 3D/HitDrum.pcm"
MetalCrashHit	IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic 3 & K & 3D/MetalCrashHit.pcm"
EchoedClapHit	IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic 3 & K & 3D/EchoedClapHit.pcm"
HipHopHitKick	IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic 3 & K & 3D/HipHopHitKick.pcm"
HipHopPowerKick	IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic 3 & K & 3D/HipHopPowerKick.pcm"
BassHey		IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic 3 & K & 3D/BassHey.pcm"
DanceStyleKick	IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic 3 & K & 3D/DanceStyleKick.pcm"
HipHopHitKick2	IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic 3 & K & 3D/HipHopHitKick2.pcm"
RevFadingWind	IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic 3 & K & 3D/RevFadingWind.pcm"
ScratchS3	IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic 3 & K & 3D/ScratchS3.pcm"
LooseSnareNoise	IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic 3 & K & 3D/LooseSnareNoise.pcm"
PowerKick2	IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic 3 & K & 3D/PowerKick2.pcm"
CrashNoiseWoo	IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic 3 & K & 3D/CrashNoiseWoo.pcm"
QuickHit	IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic 3 & K & 3D/QuickHit.pcm"
KickHey		IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic 3 & K & 3D/KickHey.pcm"
    endif

    if SMPS_S3DDACSamples
MetalCrashS3D	IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic 3 & K & 3D/MetalCrashS3D.pcm"
IntroKickS3D	IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic 3 & K & 3D/IntroKickS3D.pcm"
    endif

    if SMPS_S3DACSamples
EchoedClapHitS3	IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic 3 & K & 3D/EchoedClapHitS3.pcm"
    endif

    if SMPS_SCDACSamples
Beat		IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic Crackers/Beat.pcm"
SnareSC		IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic Crackers/SnareSC.pcm"
TimTom		IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic Crackers/TimTom.pcm"
LetsGo		IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic Crackers/LetsGo.pcm"
Hey		IncludeDAC "sound/Sonic-2-Clone-Driver-v2/DAC/Sonic Crackers/Hey.pcm"
    endif
	even
