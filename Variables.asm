...
v_jpadhold1:		ds.b	1		; joypad input - held. ALL controllers
v_jpadpress1:		ds.b	1		; joypad input - pressed. ALL controllers
					;!@ ds.b	6		; unused
					ds.b	8		; unused
...
f_pause:		ds.w	1		; flag set to pause the game
				ds.b	4		; unused
			;!@ PICO hack
;v_pico_curPage:		ds.b	1
;v_pico_oldPage:		ds.b	1
;v_pico_PageDelta:	ds.b	1
					;ds.b	1
